...
//                         <button
//                             className={`cancle_btn contionue_btn ${isContinueEnabled ? '' : 'disabled'}`}
            ...
            <div className="popup_creat">
                <div className="popup_conten_creat">
                    <input
                        ...
                        required
                    />
                    {input.trim() === "" && <p className="error_message">Quiz name is required</p>}
                    ...
                    {activeButton === "" && <p className="error_message">Quiz type is required</p>}
